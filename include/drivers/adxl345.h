...
#define ADXL345_CS_PORT				PORTE
#define ADXL345_CS_DDR		 		DDRE
#define ADXL345_CS					PE4
...
/* Chip Select macros */
#define adxl345_CS_LOW() (ADXL345_CS_PORT &= ~(1 << ADXL345_CS))
#define adxl345_CS_HIGH() (ADXL345_CS_PORT |= (1 << ADXL345_CS))
